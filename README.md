...
>**请各位认真仔细看完文档或者对应上传图片的示例!!! 如有不足之处也请指出**  


---------------------

### 分离源码(后端版12k、七牛云版13k+6k、阿里云版13k+12k、腾讯云12k+68k)
...
- sunui-upimg-tencent.vue(腾讯云版),需要复制文件夹“tencent-cos”
...
- [x]支持图片上传容量控制,单位为M,向上取整(暂时关闭该功能)
- [√]支持七牛云图片上传
- [√]支持手动上传(多谢**“手动党”**提出的建议)
- [√]支持腾讯云上传
